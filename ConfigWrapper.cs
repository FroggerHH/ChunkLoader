...
public class ConfigWrapper
{
    ...
    public ConfigEntry<string> Bind(string group, string name, string value, string description,
    ...
    private void Register(ConfigEntry<string> setting)
    {
        ...
        SettingHandlers.Add(key, (terminal, value) => SetValue(terminal, setting, name, value));
    }
